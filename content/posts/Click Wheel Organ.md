...
{{<figure src="/img/ClickOrgan/OnDesk_3.jpg" alt="Freshly glued click wheel organ" class="center" style="border-radius: 8px; width:75%" >}}
...
{{<figure src="/img/ClickOrgan/DownLength.png" alt="Python-generated wheels" class="center" style="border-radius: 8px; width:50%" >}}
...
{{<figure src="/img/ClickOrgan/GenCAD.png" alt="Python-generated wheels" class="center" style="border-radius: 8px; width:90%" >}}
...
{{<figure src="/img/ClickOrgan/ErrorPlot.png" alt="Python-generated wheels" class="center" style="border-radius: 8px; width:80%" >}}
