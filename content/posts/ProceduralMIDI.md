...
{{<figure src="/img/ProceduralMIDI/ExamplePlot.png" alt="Example Plot" class="center" style="border-radius: 8px; width:60%" >}}
...
{{<figure src="/img/ProceduralMIDI/ExampleSequence.png" alt="Example Sequence" class="center" style="border-radius: 8px; width:75%" >}}
